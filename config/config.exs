...
config :event_stream_demo, EventStreamDemoWeb.Endpoint,
  ...
  live_view: [signing_salt: "4CeZ3oBg"]
...
config :event_stream_demo, EventStreamDemo.Mailer, adapter: Swoosh.Adapters.Local
