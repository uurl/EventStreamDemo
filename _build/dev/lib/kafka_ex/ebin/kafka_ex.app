{application,kafka_ex,
             [{modules,['Elixir.Enumerable.KafkaEx.Stream','Elixir.KafkaEx',
                        ...
                        'Elixir.KafkaEx.NetworkClient.Behaviour',
                        'Elixir.KafkaEx.New.Adapter',
                        'Elixir.KafkaEx.New.Client',
                        'Elixir.KafkaEx.New.Client.Protocol',
                        'Elixir.KafkaEx.New.Client.RequestBuilder',
                        'Elixir.KafkaEx.New.Client.ResponseParser',
                        'Elixir.KafkaEx.New.Client.State',
                        'Elixir.KafkaEx.New.ClientCompatibility',
                        'Elixir.KafkaEx.New.KafkaExAPI',
                        'Elixir.KafkaEx.New.Protocols.Kayrock.DescribeGroups',
                        'Elixir.KafkaEx.New.Protocols.Kayrock.DescribeGroups.Request',
                        'Elixir.KafkaEx.New.Protocols.Kayrock.DescribeGroups.Request.Kayrock.DescribeGroups.V0.Request',
                        'Elixir.KafkaEx.New.Protocols.Kayrock.DescribeGroups.Request.Kayrock.DescribeGroups.V1.Request',
                        'Elixir.KafkaEx.New.Protocols.Kayrock.DescribeGroups.Response',
                        'Elixir.KafkaEx.New.Protocols.Kayrock.DescribeGroups.Response.Kayrock.DescribeGroups.V0.Response',
                        'Elixir.KafkaEx.New.Protocols.Kayrock.DescribeGroups.Response.Kayrock.DescribeGroups.V1.Response',
                        'Elixir.KafkaEx.New.Protocols.KayrockProtocol',
                        'Elixir.KafkaEx.New.Structs.Broker',
                        'Elixir.KafkaEx.New.Structs.ClusterMetadata',
                        'Elixir.KafkaEx.New.Structs.ConsumerGroup',
                        'Elixir.KafkaEx.New.Structs.ConsumerGroup.Member',
                        'Elixir.KafkaEx.New.Structs.ConsumerGroup.Member.MemberAssignment',
                        'Elixir.KafkaEx.New.Structs.ConsumerGroup.Member.MemberAssignment.PartitionAssignment',
                        'Elixir.KafkaEx.New.Structs.NodeSelector',
                        'Elixir.KafkaEx.New.Structs.Partition',
                        'Elixir.KafkaEx.New.Structs.Topic',
              ...
              {compile_env,[{kafka_ex,[protocol],error}]},
              {optional_applications,[]},
              {applications,[kernel,stdlib,elixir,logger,ssl,kayrock]},
